...
void setup() {
  ...
  strip4.begin(); strip4.setBrightness(50); strip4.show();
  strip5.begin(); strip5.setBrightness(50); strip5.show();
  strip6.begin(); strip6.setBrightness(50); strip6.show();
  strip7.begin(); strip7.setBrightness(50); strip7.show();
  strip8.begin(); strip8.setBrightness(50); strip8.show();
}
